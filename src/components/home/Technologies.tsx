  ...
  return (
    <section id="stack" className="px-[4vw] py-[130px]">
      <div className="mx-auto max-w-[1600px]">
        <div className="mb-[46px] flex items-center gap-[10px] font-mono text-[12px] uppercase tracking-[1.5px] text-[var(--muted)]">
        ...
        >
          {technologies.map((tech) => (
            ...
            >
              <div className="absolute inset-0 translate-y-[101%] bg-[var(--inv)] transition-transform duration-500 ease-[0.16, 1, 0.3, 1] group-hover:translate-y-0" />
              <div className="relative z-[1] flex h-full flex-col items-center justify-center gap-3.5 px-3 text-center">
                <div className="text-[30px] text-[var(--muted)] transition-all duration-500 ease-[0.16, 1, 0.3, 1] group-hover:-translate-y-1 group-hover:text-[var(--inv-ink)]">
